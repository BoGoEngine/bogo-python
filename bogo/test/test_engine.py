...
from bogo.core import _Action, _parse_transformation, process_sequence
...
class TestHelpers():
    ...
    def test__parse_transformation(self):
        # Add mark
        eq_(_parse_transformation('a^'), (_Action.ADD_MARK, Mark.HAT))
        eq_(_parse_transformation('a+'), (_Action.ADD_MARK, Mark.BREVE))
        eq_(_parse_transformation('o*'), (_Action.ADD_MARK, Mark.HORN))
        eq_(_parse_transformation('d-'), (_Action.ADD_MARK, Mark.BAR))
